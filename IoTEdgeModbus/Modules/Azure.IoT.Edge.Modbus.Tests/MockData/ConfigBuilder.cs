                 ...
                 new ModbusSlaveConfig
                    {
                        ...
                        {
                            { "Op01", new ReadOperation{ PollingInterval = 1000, UnitId =1, StartAddress = "400001", Count = 0, DisplayName= "Voltage", CorrelationId = "MessageType1", ValueType=ModbusValueType.Float } },
                            ...
                            { "Op03", new ReadOperation{ PollingInterval = 1000, UnitId =1, StartAddress = "400003", Count = 3, DisplayName= "Counter", CorrelationId = "MessageType3",ValueType=ModbusValueType.Int32 } },
                            { "Op04", new ReadOperation{ PollingInterval = 1000, UnitId =1, StartAddress = "10001", Count = 2, DisplayName= "OnOff", CorrelationId = "MessageType4", ValueType=ModbusValueType.Int32} }
                        }
                    }
                }
            };
